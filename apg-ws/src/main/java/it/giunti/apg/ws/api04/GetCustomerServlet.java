...
/*@WebServlet(Constants.PATTERN_API04+Constants.PATTERN_GET_CUSTOMER)*/
public class GetCustomerServlet extends ApiServlet {
	private static final long serialVersionUID = 8924323276442829691L;
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (result == null) {
			...
			try {
				...
				if (anag == null) anag = new AnagraficheDao().findByMergedUid(ses, idCustomer);
