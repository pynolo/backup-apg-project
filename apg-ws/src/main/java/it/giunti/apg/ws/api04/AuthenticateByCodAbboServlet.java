...
/*@WebServlet(Constants.PATTERN_API04+Constants.PATTERN_AUTHENTICATE_BY_COD_ABBO)*/
public class AuthenticateByCodAbboServlet extends ApiServlet {
	private static final long serialVersionUID = -6810091889826659265L;
		...
		if (result == null) {
			...
			try {
				...
				if (ia == null) {
					...
					anag = new AnagraficheDao().findByUid(ses, codAbbo, false);
					if (anag == null) {
