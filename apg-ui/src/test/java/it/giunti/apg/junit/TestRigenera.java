...
public class TestRigenera {
	...
	public void test() {
		...
		try {
			...
			assertTrue("checked data inizio ", newIstanzeAbbonamenti.getFascicoloInizio().getDataInizio().before(new Date()) && 
					newIstanzeAbbonamenti.getFascicoloInizio().getDataFine().after(new Date()));
