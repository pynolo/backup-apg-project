...
public class RinnovoMassivoUtil {
	...
	public static List<IstanzeAbbonamenti> findIstanzeByDataListinoPagato(Session ses, Listini lst,
			Date dataInizio, boolean soloRegolari, 
	...
	@SuppressWarnings("unchecked")
	public static long countIstanzeByDataListinoPagato(Session ses, Listini tal,
			Date dataInizio, boolean soloRegolari,
	...
	public static IstanzeAbbonamenti renewToTransientNoOpzioni(Session ses, IstanzeAbbonamenti oldIa,
		...
		try {
			...
			cal.setTime(oldIa.getDataFine());
			cal.add(Calendar.DAY_OF_MONTH, 1);
			ia.setDataInizio(cal.getTime());
