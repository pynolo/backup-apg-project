...
public interface AbbonamentiService extends RemoteService {
	...
	public List<IstanzeAbbonamenti> findLastIstanzeByAnagraficaSocieta(Integer idAnagrafica, String idSocieta, boolean soloPagate, boolean soloScadute) throws BusinessException;
