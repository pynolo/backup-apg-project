...
public class ModelliEmailFrame extends FramePanel implements IAuthenticatedWidget {
	...
	private FlowPanel getLegendaPanel() {
		...
		legendaTable.setHTML(r, 3, "<b>%"+EmailConstants.VAL_CODICE_ABBONAMENTO+"%</b>");
		legendaTable.setHTML(r, 4, "Codice abbonamento");
		r++;
		legendaTable.setHTML(r, 0, "<b>%"+EmailConstants.VAL_CODICE_ANAGRAFICA+"%</b>");
		legendaTable.setHTML(r, 1, "Codice anagrafica");
		legendaTable.setHTML(r, 3, "<b>%"+EmailConstants.VAL_CODICE_ANAGRAFICA_PAG+"%</b>");
		legendaTable.setHTML(r, 4, "Codice anagrafica pagante");
		r++;
		legendaTable.setHTML(r, 0, "<b>%"+EmailConstants.VAL_COPIE+"%</b>");
		legendaTable.setHTML(r, 1, "Copie");
		legendaTable.setHTML(r, 3, "<b>%"+EmailConstants.VAL_PROVINCIA+"%</b>");
		legendaTable.setHTML(r, 4, "Sigla provincia, <i>se disponibile</i>");
		r++;
