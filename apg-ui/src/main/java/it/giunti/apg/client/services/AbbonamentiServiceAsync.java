...
public interface AbbonamentiServiceAsync {
	...
	void findLastIstanzePagateByAnagraficaSocieta(Integer idAnagrafica, String idSocieta, boolean soloPagate, boolean soloScadute, AsyncCallback<List<IstanzeAbbonamenti>> callback);
