...
public interface LoggingServiceAsync {
	...
	void findFattureInvioSap(Long startDt, Long finishDt, boolean errorOnly,
			int offset, int pageSize, AsyncCallback<List<FattureInvioSap>> callback);
	...
	void saveAvviso(Avvisi avviso, AsyncCallback<Integer> callback);
	...
	void checkMaintenance(AsyncCallback<Avvisi> callback);
