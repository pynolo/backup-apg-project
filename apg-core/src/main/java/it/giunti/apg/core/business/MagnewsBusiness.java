...
public class MagnewsBusiness {
	...
	public List<BatchEmailMessage> createBatchEmailMessage(List<EvasioniComunicazioni> ecList,
			String fromEmail, String fromName, String idMessageType, String idNewsletter) {
		...
		for (EvasioniComunicazioni ec:ecList) {
			...
			cssinline.setValue(idNewsletter);
