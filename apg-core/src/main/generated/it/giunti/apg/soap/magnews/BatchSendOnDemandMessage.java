...
/**
 * <p>Java class for batchSendOnDemandMessage complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="batchSendOnDemandMessage">
 *   &lt;complexContent>
 ...
 *         &lt;element name="contactPrimaryKeys" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "batchSendOnDemandMessage", propOrder = {
    "idNewsletter",
    "idDatabase",
    "contactPrimaryKeys",
    "options",
...
public class BatchSendOnDemandMessage {

    protected String idNewsletter;
    protected String idDatabase;
    protected List<String> contactPrimaryKeys;
    ...
    /**
     * Gets the value of the contactPrimaryKeys property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the contactPrimaryKeys property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getContactPrimaryKeys().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<String> getContactPrimaryKeys() {
        if (contactPrimaryKeys == null) {
            contactPrimaryKeys = new ArrayList<String>();
        }
        return this.contactPrimaryKeys;
    }
