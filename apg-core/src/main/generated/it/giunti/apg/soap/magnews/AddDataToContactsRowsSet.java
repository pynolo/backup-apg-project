...
/**
 * <p>Java class for addDataToContactsRowsSet complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="addDataToContactsRowsSet">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="idRowSet" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *         &lt;element name="data" type="{http://webservices.magnews/}rawContactData" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "addDataToContactsRowsSet", propOrder = {
    "idRowSet",
    "data",
    "options",
    "credentials"
})
public class AddDataToContactsRowsSet {

    protected String idRowSet;
    protected List<RawContactData> data;
     ...
     * 
     */
    public List<RawContactData> getData() {
        if (data == null) {
            data = new ArrayList<RawContactData>();
        }
        return this.data;
    }
